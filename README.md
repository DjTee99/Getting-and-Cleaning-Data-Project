...
* `CodeBook.md`, the code book, which describes the contents of the data set (dataset, variables and transformations used to generate the data).
...
The `tidydataset.txt` in this repository was created by running the `run_analysis.R` script using R version 
